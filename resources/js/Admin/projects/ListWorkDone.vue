            ...
            <table class="table-striped table-responsive table-hover result-point"
                ...
                <tr v-for="(item, index) in list" :key="item.id" style="text-align:center;">
                    <template v-if="item.task_performer != null">
                        ...
                        <td>
                            <input type="date" style="width: 100%; border:0px;" @change="changeStartTime($event, item.id)" v-model="item.start_time">
                        </td>
                            ...
                            <div style="display: flex">
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                    ...
                                    <option value="4"
                                        ...
                                        Hoàn thành </option>
                                    <option value="0" style="color:#ff0000">Đã quá hạn</option>
                                </select>
                            </div>
                        </td>
                    </template>
