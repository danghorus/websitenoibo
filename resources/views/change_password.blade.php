...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h2>Horus Work - Thay đổi mật khẩu</h2></div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('change.password') }}">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">Xác nhận lại mật khẩu mới</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4" style="float: right;">
                                    ...
                                    <button type="submit" class="btn btn-primary" style="margin: 0px 0px 0px 150px;">
                                        Cập nhật mật khẩu
                                    </button>
                                </div>
                            </div>
