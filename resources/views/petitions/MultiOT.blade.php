 <div class="modal fade" id="exampleModal_multiOT" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     <div class="modal-dialog" role="document">
        <div class="modal-content" style="width:100%;">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">ĐKLC nhiều ngày</h3>
            ...
            <div class="modal-body">
                <form action="{{ route('petitions.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                     ...
                     <div class="form-floating mb-3">
                        <input class="form-control" name="type_OT" type="text" value="4" hidden/>
