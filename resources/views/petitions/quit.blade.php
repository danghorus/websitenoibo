 <div class="modal fade"  data-bs-backdrop="static" data-bs-keyboard="false"  id="exampleModal_quit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="width:100%;">
            ...
            <div class="modal-body">
                <form action="{{ route('petitions.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control" name="petition_type" type="text" value="3" hidden/>
                        <label for="">loại yêu cầu</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input class="form-control" id="date_from" name="date_from" type="date" />
                        <script>
                            document.getElementById('date_from').value = new Date().toISOString().substring(0, 10);
                        </script>
